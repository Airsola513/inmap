...
var HoneycombOverlay = exports.HoneycombOverlay = {
    ...
    honeycombGrid: function honeycombGrid(data, map, nwMc, size, zoomUnit, mapSize, mapCenter) {
...
var LabelHelper = exports.LabelHelper = {
	arrangeLabels: function arrangeLabels(webObj) {
		console.log(webObj);
...
var _HeatOverlay = __webpack_require__(28);

var _GriddingOverlay = __webpack_require__(27);

var _BoundaryOverlay = __webpack_require__(25);

var _Circuit = __webpack_require__(26);

var _HoneycombOverlay = __webpack_require__(29);

var _polymeOverlay = __webpack_require__(44);

var _LabelHelper = __webpack_require__(30);
...
var callbackList = {
    ...
    'LabelHelper': _LabelHelper.LabelHelper,
...
var polymeOverlay = exports.polymeOverlay = {
    ...
    mergePoint: function mergePoint(webObj) {
        ...
        data.forEach(function (val) {
            var pixel = (0, _index.pointToPixelWorker)(val, webObj.request.map);
            val['pixel'] = {
                x: pixel.x,
                y: pixel.y,
                radius: radius
