    ...
    <Menu mode="horizontal" :active-name="currentActiveKey" @on-select="handleSelect">
        <div class="wrapper-header-nav">
            ...
            <div class="wrapper-header-nav-search">
                <!-- <i-select ref="select" v-model="search" filterable :placeholder="searchText" :not-found-text="notFoundText" @on-change="handleSearch">
        ...
        methods: {
            ...
            handleSelect(type) {
                ...
                if (type === 'donate') {
                    ...
                    window.open('https://github.com/TalkingData/inmap');
                } else if (type === 'guide') {
            ...
            handleChangeLang() {
                ...
                const path = this.$route.path.indexOf('-en') > -1 ? this.$route.path.split('-en')[0] : this.$route.path +
                    '-en';
